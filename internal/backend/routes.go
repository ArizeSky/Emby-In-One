...
func (a *App) Handler() http.Handler {
	...
	mux.HandleFunc("PUT /admin/api/upstream/{id}", a.withContext(a.requireAdmin(a.handleAdminUpstreamUpdate)))
	mux.HandleFunc("POST /admin/api/upstream/reorder", a.withContext(a.requireAdmin(a.handleAdminUpstreamReorder)))
	mux.HandleFunc("DELETE /admin/api/upstream/{id}", a.withContext(a.requireAdmin(a.handleAdminUpstreamDelete)))
	mux.HandleFunc("POST /admin/api/upstream/{id}/reconnect", a.withContext(a.requireAdmin(a.handleAdminUpstreamReconnect)))
	...
	mux.HandleFunc("GET /admin/{$}", a.handleAdminPanel)
